...
def wine_response(
    ...
    *,
    ...
    return WineResponse(
        ...
        vineyard_country=wine.vineyard_country or "",
        ...
        vineyard_source_title=wine.vineyard_source_title or "",
        vineyard_notes=wine.vineyard_notes or "",
        vineyard_verified_at=wine.vineyard_verified_at,
        vineyard_not_found=wine.vineyard_not_found,
