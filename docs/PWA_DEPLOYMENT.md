...
server {
    ...
    # Intelligence can take longer than the standard proxy timeout because it
    # creates a structured plan for the entire cellar.
    location = /api/v1/ai/cellar-intelligence {
