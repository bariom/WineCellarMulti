    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Use AI suggestions, if configured, to refine buying strategy, purpose, and market price.",
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          "Notifications help you track invites, redeem codes, approvals, expiring access, and incoming shared positions.",
