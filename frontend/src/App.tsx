...
const translations = {
  ...
  it: {
    ...
    aiModelsHelpIntro: "Ogni richiesta AI costa pochi centesimi (stima indicativa). Sono valori per una richiesta breve; testi lunghi o ricerche web possono costare molto di più.",
    ...
    aiModelsHelpPremium: "gpt-5.5 · circa 2-3 centesimi: usa solo quando serve qualità extra.",
    aiModelsHelpLuna: "gpt-5.6-luna · circa 0,4-0,5 centesimi: semplice, veloce ed economico.",
    aiModelsHelpTerra: "gpt-5.6-terra · circa 0,8-1,2 centesimi: qualità e costo bilanciati.",
    aiModelsHelpSol: "gpt-5.6-sol · circa 2 centesimi: massima qualità per analisi complesse.",
