...
const translations = {
  en: {
    ...
    aiModelsHelpIntro: "These are practical estimates for a short real request, such as enriching one wine with about 1,000 input tokens and 500 output tokens. Actual cost changes with prompt length and answer length.",
    aiModelsHelpNano: "gpt-5.4-nano: about $0.001 per compact grape-composition request. Best for simple extraction and very low-cost enrichment.",
  ...
  it: {
    ...
    aiModelsHelpIntro: "Queste sono stime pratiche per una richiesta reale breve, ad esempio arricchire un vino con circa 1.000 token input e 500 token output. Il costo effettivo cambia con lunghezza del prompt e della risposta.",
    aiModelsHelpNano: "gpt-5.4-nano: circa $0.001 per una richiesta uvaggio compatta. Ideale per estrazioni semplici e arricchimenti a costo molto basso.",
