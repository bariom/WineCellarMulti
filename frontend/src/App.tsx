...
const translations = {
  en: {
    ...
    aiModelsHelpIntro: "Every AI request costs a few cents. These estimates are for a short request; very long text or web research can cost more.",
    ...
    aiModelsHelpPremium: "gpt-5.5 · about 2-3 cents: use when extra quality matters.",
    aiModelsHelpLuna: "gpt-5.6-luna · under 1 cent: simple, fast, and economical.",
    aiModelsHelpTerra: "gpt-5.6-terra · about 1 cent: balanced quality and cost.",
    aiModelsHelpSol: "gpt-5.6-sol · about 2 cents: highest quality for complex analysis.",
  ...
  it: {
    ...
    aiModelsHelpIntro: "Ogni richiesta AI costa pochi centesimi. Queste stime valgono per una richiesta breve; testi molto lunghi o ricerche web possono costare di piu.",
    aiModelsHelpNano: "gpt-5.4-nano · meno di 1 centesimo: attivita semplici e veloci.",
    aiModelsHelpMini: "gpt-5.4-mini · meno di 1 centesimo: buon equilibrio per testi e analisi leggere.",
    aiModelsHelpStandard: "gpt-5.4 · circa 1-2 centesimi: abbinamenti, finestre di beva e decisioni normali.",
    aiModelsHelpPremium: "gpt-5.5 · circa 2-3 centesimi: usalo quando serve piu qualita.",
    aiModelsHelpLuna: "gpt-5.6-luna · meno di 1 centesimo: semplice, veloce ed economico.",
    aiModelsHelpTerra: "gpt-5.6-terra · circa 1 centesimo: qualita e costo ben bilanciati.",
    aiModelsHelpSol: "gpt-5.6-sol · circa 2 centesimi: massima qualita per analisi complesse.",
