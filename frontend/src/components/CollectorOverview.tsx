...
export function CollectorOverview({ wines, locale, now, refreshDays, onOpen }: {
  ...
  return <section className="collector-overview" aria-label={it ? "Panoramica collezionista" : "Collector overview"}>
    ...
    <CollectorCardGroup className="collector-summary-grid" locale={locale} label={it ? "Indicatori della cantina" : "Cellar indicators"}>
      <article className="collector-tile collector-value"><h3>{heading("chart", it ? "Valore della collezione" : "Collection value")}</h3>
      ...
      <article className="collector-tile"><h3>{heading("cellar", it ? "Disponibilità" : "Availability")}</h3>
      ...
      <article className="collector-tile"><h3>{heading("dashboard", it ? "Copertura valutazioni" : "Valuation coverage")}</h3>
    ...
    <Composition className="collector-composition" aria-label={it ? "Maturità e composizione" : "Maturity and composition"}>
      {mobile ? <summary>{heading("dashboard-cards", it ? "Maturità e composizione" : "Maturity and composition")}</summary> : <h2>{heading("dashboard-cards", it ? "Maturità e composizione" : "Maturity and composition")}</h2>}
