...
export const helpArticles = createHelpArticles("en", [
  ...
  ["restaurant-mode", "cellar", ["home", "cellar", "settings"], writeRoles, "Restaurant cellar", "Record bottle sales and review revenue, cost and gross margin.", "Select Restaurant under Settings > Structure.|Set purchase and sale prices on each wine.|Use Sell bottles and review the restaurant dashboard.", "Gross margin is operational information, not an accounting or tax calculation. Different currencies are never added together.", "wine-detail|import-export"],
