...
export const helpArticles = createHelpArticles("en", [
  ...
  ["consumption", "cellar", ["cellar", "history"], writeRoles, "Consumption and tastings", "Record a consumed bottle and retain the tasting in History.", "Open wine details.|Record a consumed bottle.|Add note, rating and pairing.", "Consumption decreases cellar quantity.", "wine-detail|history"],
  ...
  relatedViews: relatedViews as Array<"home" | "cellar" | "history" | "wishlist" | "pairing" | "buying" | "settings">,
