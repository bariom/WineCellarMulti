...
export const translations = {
  en: {
    ...
    recognitionEnrich: "Complete the form",
    recognitionEnrichHelp: "Adds type, country, region, appellation, and grape composition. It does not calculate drinking window or market value.",
    recognitionFullEnrichment: "Save and analyse everything",
    recognitionFullEnrichmentHelp: "Saves the wine first, then adds cellar notes, drinking window, market value, and verified grapes in one analysis.",
    recognitionEnrichmentChoiceTitle: "How would you like to continue?",
    recognitionEnrichmentChoiceHelp: "Choose whether to complete the editable form or save the wine and run the full AI analysis.",
    recognitionEnrichmentHelpTitle: "AI usage and cost",
    recognitionEnrichmentCostHelp: "Enrich uses a focused AI request and normally costs less. Full enrichment is a larger request and may include live web searches, so its cost is higher and variable.",
    ...
    recognitionBetaNotice: "Vinaris reads the visible label details and proposes a wine for your confirmation.",
    ...
    aiBudgetUsage: "Usage",
    aiCreditsHelp: "Free-tier AI runs through an app-managed AI Pack purchased through Stripe. Subscribers may alternatively configure a personal OpenAI key.",
    aiSettingsHelpTitle: "How AI access works",
    aiSettingsHelpKey: "Personal OpenAI keys are available with a subscription. Free-tier accounts use a Vinaris AI Pack instead.",
    ...
    missingCellarPurpose: "Missing cellar purpose",
    aiAudit: "AI audit",
    ...
    wishlistPortfolioStrategyHelp: "Compare the saved wines by personal fit, verified quality and value to decide what to buy now.",
    wishlistUseTasteProfile: "Consider my taste profile",
    wishlistTasteProfileApplied: "Personal taste included in this strategy",
    wishlistTasteProfileNotApplied: "This strategy is independent of personal taste",
    wishlistFlowsEyebrow: "Two clear paths",
    wishlistFlowsTitle: "What would you like to do?",
    wishlistFlowsHelp: "Evaluate a specific offer first, or turn the whole wishlist into a buying plan.",
    wishlistOfferFlowTitle: "Evaluate an offer",
    wishlistOfferFlowHelp: "Save the exact wine and offered price, then compare it with live market sources.",
    wishlistOfferFlowSteps: "Add the offer · Analyse the price · Decide",
    wishlistOfferFlowAction: "Add an offer",
    wishlistStrategyFlowTitle: "Build a buying strategy",
    wishlistStrategyFlowHelp: "Compare all saved wines by taste fit, verified quality and value to decide what to buy now.",
    wishlistStrategyFlowSteps: "Analyse the list · Prioritise · Allocate capital",
    wishlistStrategyFlowNeedsWine: "Add at least one wine to create the strategy.",
    ...
    wishlistStrategyOutdated: "Strategy needs updating",
    ...
    aiMagicBuying: "I'm evaluating wines against your taste, quality, budget, and selected criteria. When requested, I also check retailers and current availability.",
    aiMagicBuyingHint: "Every recommendation includes a supporting source; retailer availability is checked only when requested.",
    ...
    aiMagicLabelCellarIntelligence: "Cellar plan",
    aiMagicLabelCellarIntelligenceSelection: "Selected-wine review",
    ...
    aiMagicCellarIntelligence: "Reviewing your whole cellar against bottle purposes, drinking windows, values, and data quality.",
    aiMagicCellarIntelligenceSelection: "Reassessing the selected wines against their purpose, maturity, value, and available data.",
    create: "Create",
    ...
    regionalGapHelp: "Current value allocation compared with your target portfolio. Regions outside the tracked axes are grouped under Other origins.",
    regionalOtherOrigins: "Other origins",
    aiTools: "AI tools",
    ...
    dailySommelierTitle: "Cellar sommelier",
    dailySommelierAvailable: "Advice available",
    dailySommelierCandidateOne: "wine to open now",
    dailySommelierCandidates: "wines to open now",
    dailySommelierIntro: "Chosen from your cellar by drinking window, urgency and recent rotation.",
    dailySommelierCellarIntro: "Its drinking window deserves attention.",
    dailySommelierEmpty: "Complete drinking windows to receive a free, personal selection.",
    dailySommelierFree: "Internal recommendations · no AI cost",
    dailySommelierPairing: "Ask for an AI pairing",
    ...
    dailyReasonPastWindow: "Past its drinking window: open it soon",
    dailyReasonAtPeak: "Currently at its maturity peak",
    dailyReasonSoon: "Its maturity peak is approaching",
    ...
    importSupports: "Supports Vinaris exports and compatible legacy JSON.",
    ...
    ownership: "Ownership",
    pairing: "Pairing",
    buyingSommelier: "Buying sommelier",
    ...
    pairingIgnorePreferences: "Consider my taste profile",
    ...
    pendingEmailVerification: "Account created: check your email",
    pendingEmailVerificationHelp: "We sent you a confirmation email. You must open its link and confirm your address before you can sign in. Delivery can take up to a minute; check your spam folder too.",
    registrationEmailGuideTitle: "After creating your account, confirm your email",
    registrationEmailGuideHelp: "You will not sign in immediately. We will email you an activation link: open it, confirm your address, then return here and sign in.",
    verificationCheckInbox: "Check your inbox and, if needed, your spam folder.",
    verificationOpenLink: "Open the Vinaris email and follow its confirmation link.",
    verificationReturnToLogin: "After confirmation, return to Vinaris and sign in.",
    emailVerificationReady: "You opened the link: now confirm your email",
    emailVerificationReadyHelp: "Press the button below to complete activation. You will then be guided directly to sign in. This extra click prevents automatic email scanners from activating accounts.",
    confirmEmail: "Confirm email",
    emailVerificationSuccess: "Email confirmed. You can now sign in.",
    emailVerificationSuccessTitle: "Your account is active",
    emailVerificationSuccessHelp: "Your email has been confirmed. Sign in now with the email address and password you chose during registration.",
    signInNow: "Sign in now",
    emailVerificationExpired: "Email confirmation link expired. Request a new confirmation email.",
    ...
    themeTicino: "Ticino",
    themeMaisonChampagne: "Maison Champagne",
    themePietraVigna: "Pietra & Vigna",
    themeCavePrivee: "Cave Privée",
    ...
    vintage: "Vintage",
    vintageHelp: "No declared vintage? Choose NV (non-vintage) or MV (multi-vintage).",
  ...
  it: {
    ...
    recognitionEnrich: "Completa la scheda",
    recognitionEnrichHelp: "Aggiunge tipo, paese, regione, denominazione e composizione delle uve. Non calcola finestra di beva o valore di mercato.",
    recognitionFullEnrichment: "Salva e analizza tutto",
    recognitionFullEnrichmentHelp: "Salva prima il vino, poi aggiunge note di cantina, finestra di beva, valore di mercato e uve verificate in un’unica analisi.",
    recognitionEnrichmentChoiceTitle: "Come vuoi continuare?",
    recognitionEnrichmentChoiceHelp: "Scegli se completare la scheda modificabile oppure salvare il vino e avviare l’analisi AI completa.",
    recognitionEnrichmentHelpTitle: "Utilizzo AI e costi",
    recognitionEnrichmentCostHelp: "Enrich usa una richiesta AI mirata e normalmente costa meno. Il Full enrichment è più ampio e può includere ricerche web live, quindi il costo è maggiore e variabile.",
    ...
    recognitionBetaNotice: "Vinaris legge i dettagli visibili dell’etichetta e propone un vino da confermare.",
    ...
    aiCreditsHelp: "Nel piano gratuito l'AI usa un AI Pack gestito dall'app e acquistato tramite Stripe. Gli abbonati possono in alternativa configurare una chiave OpenAI personale.",
    aiSettingsHelpTitle: "Come funziona l'accesso AI",
    aiSettingsHelpKey: "La chiave OpenAI personale è disponibile con un abbonamento. Il piano gratuito usa invece un AI Pack Vinaris.",
    ...
    missingCellarPurpose: "Obiettivo cantina mancante",
    aiAudit: "Audit AI",
    ...
    wishlistPortfolioStrategyHelp: "Confronta i vini salvati per affinità personale, qualità verificata e convenienza, così da scegliere cosa acquistare ora.",
    wishlistUseTasteProfile: "Considera il mio profilo di gusto",
    wishlistTasteProfileApplied: "Gusto personale incluso in questa strategia",
    wishlistTasteProfileNotApplied: "Questa strategia è indipendente dal gusto personale",
    wishlistFlowsEyebrow: "Due percorsi chiari",
    wishlistFlowsTitle: "Cosa vuoi fare?",
    wishlistFlowsHelp: "Valuta prima un'offerta specifica oppure trasforma l'intera wishlist in un piano d'acquisto.",
    wishlistOfferFlowTitle: "Valuta un'offerta",
    wishlistOfferFlowHelp: "Salva il vino esatto e il prezzo proposto, poi confrontalo con fonti di mercato live.",
    wishlistOfferFlowSteps: "Inserisci l'offerta · Analizza il prezzo · Decidi",
    wishlistOfferFlowAction: "Aggiungi un'offerta",
    wishlistStrategyFlowTitle: "Crea una strategia d'acquisto",
    wishlistStrategyFlowHelp: "Confronta tutti i vini salvati per affinità, qualità verificata e convenienza, così da decidere cosa acquistare ora.",
    wishlistStrategyFlowSteps: "Analizza la lista · Dai priorità · Alloca il capitale",
    wishlistStrategyFlowNeedsWine: "Aggiungi almeno un vino per creare la strategia.",
    ...
    wishlistStrategyOutdated: "Strategia da aggiornare",
    ...
    aiMagicBuying: "Valuto i vini rispetto ai tuoi gusti, alla qualità, al budget e ai criteri scelti. Se richiesto, verifico anche rivenditori e disponibilità attuale.",
    aiMagicBuyingHint: "Ogni consiglio include una fonte; la disponibilità presso i rivenditori viene verificata solo quando la richiedi.",
    ...
    aiMagicLabelCellarIntelligence: "Piano della cantina",
    aiMagicLabelCellarIntelligenceSelection: "Riesame vini selezionati",
    ...
    aiMagicCellarIntelligence: "Sto analizzando l'intera cantina: obiettivi delle bottiglie, finestre di beva, valori e qualità dei dati.",
    aiMagicCellarIntelligenceSelection: "Sto riesaminando i vini selezionati: obiettivo, maturità, valore e dati disponibili.",
    create: "Crea",
    ...
    snoozeAction: "Rimanda di 14 giorni",
    ...
    regionalGapHelp: "Allocazione attuale del valore rispetto al portafoglio target. Le regioni fuori dagli assi tracciati confluiscono in Altre origini.",
    regionalOtherOrigins: "Altre origini",
    ...
    dailySommelierTitle: "Sommelier della cantina",
    dailySommelierAvailable: "Consiglio disponibile",
    dailySommelierCandidateOne: "vino da aprire ora",
    dailySommelierCandidates: "vini da aprire ora",
    dailySommelierIntro: "Scelti dalla tua cantina in base a finestra di beva, urgenza e rotazione recente.",
    dailySommelierCellarIntro: "La sua finestra di beva merita attenzione.",
    dailySommelierEmpty: "Completa le finestre di beva per ricevere una selezione personale e gratuita.",
    dailySommelierFree: "Consigli interni · nessun costo AI",
    dailySommelierPairing: "Chiedi un abbinamento AI",
    ...
    dailyReasonPastWindow: "Finestra superata: meglio aprirlo senza aspettare",
    dailyReasonAtPeak: "È al suo picco di maturità",
    dailyReasonRotation: "Proposto per variare rispetto alle ultime bevute",
    dailyReasonSoon: "Il picco di maturità si avvicina",
    ...
    importSupports: "Supporta export Vinaris e JSON legacy compatibili.",
    ...
    membershipValidity: "Validità abbonamento",
    ...
    ownership: "Proprietà",
    pairing: "Abbinamento",
    buyingSommelier: "Sommelier acquisti",
    ...
    pairingIgnorePreferences: "Considera il mio profilo di gusto",
    ...
    pendingEmailVerification: "Account creato: controlla la tua email",
    pendingEmailVerificationHelp: "Ti abbiamo inviato un'email di conferma. Devi aprire il link e confermare l'indirizzo prima di poter accedere. L'arrivo può richiedere fino a un minuto; controlla anche la cartella spam.",
    registrationEmailGuideTitle: "Dopo la creazione, conferma la tua email",
    registrationEmailGuideHelp: "Non entrerai subito nell'app. Ti invieremo un link di attivazione via email: aprilo, conferma l'indirizzo, poi torna qui e accedi.",
    verificationCheckInbox: "Controlla la posta in arrivo e, se necessario, la cartella spam.",
    verificationOpenLink: "Apri l'email di Vinaris e segui il link di conferma.",
    verificationReturnToLogin: "Dopo la conferma, torna su Vinaris ed effettua l'accesso.",
    emailVerificationReady: "Hai aperto il link: ora conferma l'email",
    emailVerificationReadyHelp: "Premi il pulsante qui sotto per completare l'attivazione. Subito dopo verrai guidato all'accesso. Questo clic aggiuntivo evita che gli scanner automatici delle email attivino l'account al posto tuo.",
    confirmEmail: "Conferma email",
    emailVerificationSuccess: "Email confermata. Ora puoi accedere.",
    emailVerificationSuccessTitle: "Il tuo account è attivo",
    emailVerificationSuccessHelp: "La tua email è stata confermata. Accedi ora con l'indirizzo e la password scelti durante la registrazione.",
    signInNow: "Accedi ora",
    emailVerificationExpired: "Il link di conferma email è scaduto. Richiedi una nuova email di conferma.",
    ...
    vintage: "Annata",
    vintageHelp: "Nessuna annata dichiarata? Scegli NV (senza annata) o MV (multi-annata).",
...
export const themeOptions: Array<{ value: ThemePreference; label: TranslationKey }> = [
  ...
  { value: "maison-champagne", label: "themeMaisonChampagne" },
  { value: "pietra-vigna", label: "themePietraVigna" },
  { value: "cave-privee", label: "themeCavePrivee" },
