...
export const translations = {
  en: {
    ...
    geographicMapHelp: "Drag or zoom to explore the regions represented in your cellar. Dot size shows the number of bottles.",
  ...
  it: {
    ...
    geographicMapHelp: "Trascina o usa lo zoom per esplorare le regioni presenti in cantina. La dimensione del pallino indica il numero di bottiglie.",
