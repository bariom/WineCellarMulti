...
export const translations = {
  en: {
    ...
    maturityApproaching: "Approaching peak",
    maturityPotentialCaption: "in a phase of maximum expression.",
    ...
    maturityFinancialRisk: "Financial risk if bottles remain in the cellar",
    maturityExpectedLoss: "Estimated loss",
    maturityValueExposed: "Value past maximum window",
    maturityAverageRisk: "Average deterioration risk",
    maturityFinancialRiskHelp: "Management scenario assuming the bottles remain in the cellar and a deteriorated bottle loses its full value: risk starts after the maximum drinking year at 15% and increases cumulatively each additional year. Storage conditions and the individual bottle may change the outcome; this is not an appraisal.",
  ...
  it: {
    ...
    maturityApproaching: "In avvicinamento",
    maturityPotentialCaption: "in una fase di massima espressione.",
    ...
    maturityFinancialRisk: "Rischio finanziario se le bottiglie restano in cantina",
    maturityExpectedLoss: "Perdita stimata",
    maturityValueExposed: "Valore oltre finestra massima",
    maturityAverageRisk: "Rischio medio di deterioramento",
    maturityFinancialRiskHelp: "Scenario gestionale ipotizzando che le bottiglie restino in cantina e che una bottiglia deteriorata perda tutto il suo valore: il rischio parte dopo l'anno massimo di beva al 15% e cresce in modo cumulativo ogni anno successivo. Conservazione e singola bottiglia possono cambiare l'esito; non è una perizia.",
