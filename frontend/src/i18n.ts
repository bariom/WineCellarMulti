...
export const translations = {
  en: {
    ...
    photoUsageDisclaimerConsent: "I confirm that I have read and accept the following disclaimer: Vinaris.app reserves the right to use a bottle photograph uploaded by a user as a reference photograph for other users when no photograph of that bottle is already available in the application database.",
  ...
  it: {
    ...
    photoUsageDisclaimerConsent: "Confermo di aver letto e accettato il seguente disclaimer: Vinaris.app si riserva il diritto di utilizzare la fotografia di una bottiglia caricata da un utente come fotografia di riferimento per gli altri utenti, qualora nessuna fotografia della bottiglia fosse già disponibile nel database dell’applicazione.",
