...
export const translations = {
  en: {
    ...
    aiModelsHelpLuna: "gpt-5.6-luna · about $0.001: notes, grape extraction, and other simple high-volume tasks.",
    aiModelsHelpTerra: "gpt-5.6-terra · about $0.006-$0.010: drinking windows, standard pairings, and wishlist strategy.",
  ...
  it: {
    ...
    aiModelsHelpLuna: "gpt-5.6-luna · circa 0,001 $: note, uvaggi e altre attività semplici e frequenti.",
    aiModelsHelpTerra: "gpt-5.6-terra · circa 0,006-0,010 $: finestre di beva, abbinamenti standard e strategia wishlist.",
