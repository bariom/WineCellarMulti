...
export const translations = {
  en: {
    ...
    wishlistStrategyFlowHelp: "Review all saved wines to decide what to buy now and what to monitor.",
  ...
  it: {
    ...
    wishlistStrategyFlowHelp: "Leggi tutti i vini salvati per decidere cosa comprare ora e cosa monitorare.",
